## Add data for display
 ...
 # library(stringr)
 # 
 # df_loupan = readxl::read_xlsx("./data/nanjing_xinloupan_2020-09-06.xlsx") %>% select(-c(1)) %>% distinct()
 ...
 # df_ershou = readxl::read_xlsx("data/nanjing_ershoufang_2020-09-06.xlsx") %>%
 #         distinct()
